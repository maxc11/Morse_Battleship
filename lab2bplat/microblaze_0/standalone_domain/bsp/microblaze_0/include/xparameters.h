...
#define XPAR_GPIO_1_DEVICE_ID XPAR_AXI_GPIO_ENCODER_DEVICE_ID
...
#define XPAR_INTC_0_GPIO_1_VEC_ID XPAR_MICROBLAZE_0_AXI_INTC_AXI_GPIO_ENCODER_IP2INTC_IRPT_INTR
